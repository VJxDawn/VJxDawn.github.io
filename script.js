document.addEventListener('DOMContentLoaded', () => {
  ...
  // Editable Data (Edit your links, skills, projects, and screenshots here)
  const editableData = {
    headerLinks: {
    ...
    sidebarLinks: {
      about: { url: "#about", icon: '<svg aria-label="About Icon" class="sidebar-icon" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>' },
      interests: { url: "#interests", icon: '<svg aria-label="Interests Icon" class="sidebar-icon" viewBox="0 0 24 24"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>' },
      projects: { url: "#projects", icon: '<svg aria-label="Projects Icon" class="sidebar-icon" viewBox="0 0 24 24"><path d="M9 3v2H5v14h14v-4h2v6H3V3h6zm8 2h-2v2h-2v2h-2v2h-2v2h2v2h2v2h2v-2h2v-2h2v-2h-2v-2h-2V5z"/></svg>' },
      skills: { url: "#skills", icon: '<svg aria-label="Skills Icon" class="sidebar-icon" viewBox="0 0 24 24"><path d="M7 3v2h10V3H7zm0 4v2h10V7H7zm0 4v2h10v-2H7zm-2 6h14v2H5v-2z"/></svg>' },
      education: { 
  url: "#education", 
  icon: '<svg aria-label="Education Icon" class="sidebar-icon" viewBox="0 0 24 24" fill="none" stroke="#6B5B95" stroke-width="2"><path d="M5 5h14v12H5c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm7 0v12"/></svg>' 
},
      timeline: { 
  url: "#timeline", 
  icon: '<svg aria-label="Timeline Icon" class="sidebar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 12h20" stroke-linecap="round"/><circle cx="6" cy="12" r="2" fill="currentColor"/><circle cx="12" cy="12" r="2" fill="currentColor"/><circle cx="18" cy="12" r="2" fill="currentColor"/></svg>'
},
     awards: { 
  url: "#awards", 
  icon: '<svg aria-label="Awards Icon" class="sidebar-icon" viewBox="0 0 24 24" fill="none" stroke="#6B5B95" stroke-width="2"><path d="M12 2l3 6h6l-3 6 3 6h-6l-3 6-3-6H3l3-6-3-6h6z"/><circle cx="12" cy="12" r="2"/></svg>' 
},
      certifications: { 
  url: "#certifications", 
  icon: '<svg aria-label="Certifications Icon" class="sidebar-icon" viewBox="0 0 24 24"><path fill="#FFFFFF" stroke="#6B5B95" stroke-width="2" d="M18 4H6c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zM8 8h8m-8 3h8m-8 3h8"/></svg>' 
},
     experience: { 
  url: "#experience", 
  icon: '<svg aria-label="Experience Icon" class="sidebar-icon" viewBox="0 0 24 24"><path fill="#FFFFFF" stroke="#6B5B95" stroke-width="2" d="M20 6h-4V4c0-1.1-.9-2-2-2h-4c-1.1 0-2 .9-2 2v2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zM10 4h4v2h-4V4zm10 14H4V8h16v10z"/></svg>' 
},
   contact: { 
  url: "#contact", 
  icon: '<svg aria-label="Contact Icon" class="sidebar-icon" viewBox="0 0 24 24"><path fill="#6B5B95" d="M20 2H4c-1.1 0-2 .9-2 2v16l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 12H6l-2 2V4h16v10z"/></svg>' 
} 
    },
    projectLinks: {
      portfolio: {
...
{ name: "HTML", icon: `
  <svg class="tech-icon" viewBox="0 0 128 128">
    ...
    <path fill="#EBEBEB" d="M64 66.38H46.318l-1.233-13.8H64V39.28H34.83l.321 3.646 3.3 36.96H64v-13.507zM64 98.884l-.06.017-15.508-4.208-.992-11.11H34.96l1.957 21.94 27.02 7.502.063-.018v-13.123z"/>
    <path fill="#FFF" d="M63.946 66.38V52.58h16.602l1.233-13.8H63.946V25.613h29.17l-.321 3.646-3.3 36.96H63.946zM63.946 98.884V85.762h15.48l1.174-13.093H63.946V59.243h27.662l-.947 10.623-1.958 21.94-24.757 6.84z"/>
  </svg>` },
],
    skillsProgress: [
    ...
    awards: [
      { title: "10th Boards From CBSE", description: "94.8%age", icon: '<svg class="award-icon" viewBox="0 0 24 24"><path d="M12 2L1 9l11 6 11-6-11-7zm0 13.5L3.5 10.5l8.5 5 8.5-5L12 15.5z"/></svg>' },
      { title: "ENGINEERING Entrance Examninations:", description: "JEE: 95%ILE , MHT-CET: 99.3%ILE", icon: '<svg class="award-icon" viewBox="0 0 24 24"><path d="M12 2L1 9l11 6 11-6-11-7zm0 13.5L3.5 10.5l8.5 5 8.5-5L12 15.5z"/></svg>' },
      { title: "12 Boards From MH Board", description: "80.33%age", icon: '<svg class="award-icon" viewBox="0 0 24 24"><path d="M12 2L1 9l11 6 11-6-11-7zm0 13.5L3.5 10.5l8.5 5 8.5-5L12 15.5z"/></svg>' },
     { title: "Coding Skills", description: "Completely self taught, used free paltforms such as Youtube.", icon: '<svg class="award-icon" viewBox="0 0 24 24"><path d="M12 2L1 9l11 6 11-6-11-7zm0 13.5L3.5 10.5l8.5 5 8.5-5L12 15.5z"/></svg>' },
    { title: "Verified Discord Bot in 2021", description: "used in over 2.5k servers, discontinued now.", icon: '<svg class="award-icon" viewBox="0 0 24 24"><path d="M12 2L1 9l11 6 11-6-11-7zm0 13.5L3.5 10.5l8.5 5 8.5-5L12 15.5z"/></svg>' },
   ],
    certifications: [
    {
  ...
  logo: `<svg aria-label="freeCodeCamp Icon" class="cert-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path fill="#7e57c2" d="M12 0C5.371 0 0 5.372 0 12c0 6.627 5.371 12 12 12s12-5.373 12-12c0-6.628-5.371-12-12-12zm0 22c-5.523 0-10-4.477-10-10S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm.217-5.879c1.297 0 2.35-1.26 2.35-2.812 0-1.46-.907-2.34-1.76-2.34-.482 0-.861.268-.953.674h-.029c-.07-.266-.241-.497-.496-.681-.553-.396-1.346-.293-1.896.238-.522.505-.822 1.202-.822 1.976 0 1.55 1.053 2.81 2.35 2.81.403 0 .775-.13 1.09-.353a2.17 2.17 0 0 0 1.266.488zm-3.512-4.252c.181-.175.42-.276.676-.276.268 0 .519.109.708.304.204.21.315.498.315.814 0 .313-.112.603-.314.812a1.01 1.01 0 0 1-.709.303 1.04 1.04 0 0 1-.677-.276 1.14 1.14 0 0 1-.317-.812c0-.316.113-.604.318-.81z"/>
  </svg>`
  //https://www.freecodecamp.org/certification/VihaanJain24/javascript-algorithms-and-data-structures
},
{
  ...
  logo: `<svg aria-label="freeCodeCamp Responsive Web Design Icon" class="cert-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path fill="#7e57c2" d="M12 0C5.371 0 0 5.372 0 12c0 6.627 5.371 12 12 12s12-5.373 12-12c0-6.628-5.371-12-12-12zm0 22c-5.523 0-10-4.477-10-10S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm1.5-16h-3v4h-4v3h4v5h3v-5h4v-3h-4v-4zm-1.5 8.5c-.828 0-1.5-.672-1.5-1.5s.672-1.5 1.5-1.5 1.5.672 1.5 1.5-.672 1.5-1.5 1.5z"/>
  </svg>`
  //https://www.freecodecamp.org/certification/VihaanJain24/responsive-web-design
}
],
   experiences: [
...
if (modeBtn) modeBtn.textContent = "Light Mode";*/
  ...
  setHref('contact-leetcode-link', editableData.contactLinks.leetcode);
  ...
  // Generate Experiences with Debugging
  ...
  document.getElementById('navIcon').addEventListener('click', toggleSidebar);
  ...
  const highlightActiveSection = () => {
    ...
    const aboutTop = aboutSection.getBoundingClientRect().top + window.scrollY - 100;
    ...
    if (currentSection && currentSection !== lastVisibleSection) {
      ...
      sidebarLinks.forEach(link => {
        ...
        if (link.getAttribute('href') === `#${currentSection}`) {
          ...
          if (lastDisplayedTitle !== newTitle) {
            typeText(newTitle);
